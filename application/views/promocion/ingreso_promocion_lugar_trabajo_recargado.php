...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <input type="text" name="nombre_contacto" id="nombre_contacto" class="form-control" value="<?php echo $lugar_trabajo['nombre_contacto']?>" required />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-2">
        <input type="tel" name="telefono" id="telefono" class="form-control" value="<?php echo $lugar_trabajo['telefono']?>" required/>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <input type="email" name="correo" id="correo" class="form-control" value="<?php echo $lugar_trabajo['correo']?>"  required />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-1">
        <input type="number" name="total_hombres" id="total_hombres" class="form-control" value="<?php if($lugar_trabajo['id_lugar_trabajo']=="")echo ''; else echo $lugar_trabajo['total_hombres'];?>" required />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-1">
        <input type="number" name="total_mujeres" id="total_mujeres" class="form-control" value="<?php if($lugar_trabajo['id_lugar_trabajo']=="")echo ''; else echo $lugar_trabajo['total_mujeres'];?>" required />
    </div>
</div>
