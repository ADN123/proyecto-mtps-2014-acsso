...
<script language="javascript" >
	$(document).ready(function(){
		...
		/*$('.delete-row').click(function(){
			...
			var url=base_url()+"index.php/verificacion/eliminar_lugar_trabajo/"+id;
		  	
			confirmacion(titulo, mensaje, url);
			return false;
		});	
		$(".edit-row").click(function(){
			$("#formu").load(base_url()+"index.php/verificacion/lugares_trabajo_recargado/"+$(this).data("id"));
			return false;
		});*/
	});
	...
	function editar(id){
		$("#formu").load(base_url()+"index.php/verificacion/lugares_trabajo_recargado/"+id);
		return false;
	}
</script>