...
(function($){
    $.fn.smartWizard = function(action) {
        ...
        return this.each(function(){
                ...
                function init(){
                  ...
                  btFinish = $('<button type="submit">'+options.labelFinish+'</button>').attr("id",options.idLabelFinish).addClass("buttonFinish").addClass(options.classLabelFinish);
                         ...
                         if($.isFunction(options.onFinish)) {
                            if(!options.onFinish.call(this,$(steps))){
                              return false;
                           	...
                           	if(frm.data("ok")=="false"){

							 	obj.smartWizard('showMessage','Por favor, corrija los errores para poder guardar el registro');
                           	}
							frm.submit();
    ...
    $.fn.smartWizard.defaults = {
          ...
          idLabelFinish:'guardar', 
		  classLabelFinish: 'boton_validador',         
