...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( lang )
	{
		...
		if ( ! lang.sEmptyTable && zeroRecords &&
			defaults.sEmptyTable === "Por el momento no hay datos disponibles" )
		{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *  @type string
			 *  @default Por el momento no hay datos disponibles
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sEmptyTable": "Por el momento no hay datos disponibles",
