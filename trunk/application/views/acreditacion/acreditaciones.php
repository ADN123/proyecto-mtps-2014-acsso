				...
				<div class="row">                
                	...
                	<div class="col-md-8">
                      	<div class="rdio rdio-success">
                        	...
                        	<label for="ins">Entrega Acreditaciones</label>
                      	</div>
                      	<div class="rdio rdio-success">
	...
	$(document).ready(function() {
		...
		$('#buscar').click(function(){
			...
			if(ex>1) {
				...
				window.open(base_url()+'index.php/acreditacion/resultados_acreditaciones/'+f1+'/'+f2+'/'+rep+'/'+ex);
			}
			else
				ajax_html(base_url()+'index.php/acreditacion/resultados_acreditaciones', $('#cont-resultados'), "", $('#formu').serialize())
		});
	});
</script>