<?php
	...
	if($estado_transaccion==1) {
		$class='success';
		$mensaje='<span class="glyphicon glyphicon-info-sign"></span> '.ucfirst($objeto).' se ha <strong>'.$accion_transaccion.'do</strong> éxitosamente! Si deseas crear el registro de promoción de un lugar de trabajo <a href="'.base_url().'index.php/verificacion/ingreso" class="alert-link">aquí</a>.';
	}
	else {
		$class='danger';
...
include(base_url."index.php/verificacion/calendario_dia");
?>
<div class="col-md-6">
	<div class="panel panel-primary">
        ...
        <div class="panel-body">
  			<form class="form-horizontal" name="formu" id="formu" method="post" action="<?php echo base_url()?>index.php/verificacion/guardar_programacion_nuevo" autocomplete="off">                
