	...
	$(document).ready(function() {
		...
		$('#buscar').click(function(){
			...
			if(ex>1) {
				...
				window.open(base_url()+'index.php/verificacion/resultados/'+f1+'/'+f2+'/'+rep+'/'+ex);
			}
			else
				ajax_html(base_url()+'index.php/verificacion/resultados', $('#cont-resultados'), "", $('#formu').serialize())
		});
	});
</script>