    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" id="ptab1">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" name="nombre_institucion" id="nombre_institucion" class="form-control" value="<?php echo $institucion['nombre'] ?>" required="required"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" name="nit_empleador" id="nit_empleador" class="form-control" value="<?php echo $institucion['nit_empleador'] ?>" required="required"/>
                </div>
            </div>
            <div class="form-group">
